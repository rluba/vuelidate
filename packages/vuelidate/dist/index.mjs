...
function createMetaFields(results, nestedResults, childResults) {
  ...
  const $anyChanged = computed(() => allResults.value.some(r => r.$changed) || allResults.value.some(r => r.$anyChanged) || $changed.value);
